Ext.define('StoryBoard', {
    ...
    _buildHelpComponent:function (config) {
        return Ext.create('Ext.Component', Ext.apply({
            renderTpl:'<a href="http://www.rallydev.com/help/story-board?basehost=https://rally1.rallydev.com" title="Launch Help for Story Board App" target="_blank" class="help"><img id="appHeaderrighthelp" class="appHelp" src="/apps/2.0p3/rui/resources/themes/images/default/help/icon_help.png" title="Launch Help" alt="Launch Help" style=""></a>'
        }, config));
    },
